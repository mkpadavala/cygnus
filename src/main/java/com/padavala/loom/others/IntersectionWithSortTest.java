...
public class IntersectionWithSortTest {

	
	/*
	public static void main(String[] args){

		IntersectionTest2 test = new IntersectionTest2();
	...
	public void testIntersectionOne(){
		...
		Set<String> commonList = intersection.getCommonStringsBySorting(firstList, secondList);
